...
export const Icons = {
  ...
  ClearCache: `
    <svg role="img" height="20" width="20" aria-hidden="true" viewBox="0 0 24 24" data-encore-id="icon" class="Svg-sc-ytk21e-0 Svg-img-16-icon">
  ...
  Spinner: `<svg xmlns="http://www.w3.org/2000/svg" width="{SIZE}" height="{SIZE}" viewBox="0 0 24 24" fill="none" color="currentColor" class="SL_spinAnimation" stroke-width="2" stroke="currentColor" lucide="Loader2Icon" tabler="IconLoader" hugeicons="Loading03Icon" phosphor="SpinnerIcon" role="status" aria-label="Loading"><path d="M12 3V6" stroke="currentColor" stroke-linecap="round" stroke-width="2"></path><path d="M12 18V21" stroke="currentColor" stroke-linecap="round" stroke-width="2"></path><path d="M21 12L18 12" stroke="currentColor" stroke-linecap="round" stroke-width="2"></path><path d="M6 12L3 12" stroke="currentColor" stroke-linecap="round" stroke-width="2"></path><path d="M18.3635 5.63672L16.2422 7.75804" stroke="currentColor" stroke-linecap="round" stroke-width="2"></path><path d="M7.75804 16.2422L5.63672 18.3635" stroke="currentColor" stroke-linecap="round" stroke-width="2"></path><path d="M18.3635 18.3635L16.2422 16.2422" stroke="currentColor" stroke-linecap="round" stroke-width="2"></path><path d="M7.75804 7.75804L5.63672 5.63672" stroke="currentColor" stroke-linecap="round" stroke-width="2"></path></svg>`,
  ArrowUpRight: `<svg xmlns="http://www.w3.org/2000/svg" width="{SIZE}" height="{SIZE}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-arrow-up-right-icon lucide-arrow-up-right"><path d="M7 7h10v10"/><path d="M7 17 17 7"/></svg>`,
};
